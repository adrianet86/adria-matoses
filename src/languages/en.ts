export const en = {
  ...
  about: {
    ...
    backend: "Backend",
    backendDesc: "Building robust applications with PHP, Symfony, Golang and TypeScript, focusing on maintainability and performance.",
    devops: "DevOps",
  ...
  contact: {
    title: "Get In Touch",
    subtitle: "Let's Chat",
    description: "Whether you have a project in mind, a question about my work, or just want to connect, I'd love to hear from you. My inbox is always open!",
    emailLabel: "Email",
    linkedinLabel: "LinkedIn",
    githubLabel: "GitHub",
    gitlabLabel: "GitLab",
    social: "Or connect with me on social media:",
    formName: "Your Name",
    formEmail: "Your Email",
    formMessage: "Your Message",
    formMessagePlaceholder: "I'd like to discuss a project...",
  ...
  footer: {
    ...
    builtWith: "Crafted entirely by AI, 100% code-free – just prompts"
  }
};
